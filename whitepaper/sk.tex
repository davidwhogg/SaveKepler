...
\altaffiltext{\theaddress}{\stepcounter{address}\label{datadriven}%
  Foreman-Mackey is responsible for the data-driven modeling shown in this \documentname.}
...
\altaffiltext{\theaddress}{\stepcounter{address}\label{physical}%
  Lang is responsible for the toy data simulations and the physical modeling shown in this \documentname.}
...
\item The PSF in Kepler's two-wheel era can be decomposed in two
  ...
  computer vision community (\cite{fergus2006,whyte2010,hirsch2011,koehler2012}).
...
If the science program obviates the 371-roll,
  then exopsure times might have to get shorter.
