...
\author{%
  ...
  Ben~Montet\altaffilmark{\ref{Caltech}},
...
\item The PSF in Kepler's two-wheel era can be decomposed in two
  ...
  will help to constrain this motion. Any additional knowledge about
  the spacecraft's pointing position will facilitate the estimation
  procedure. Note, that for an individual exposure we can be agnostic
  about the chronological history and temporal evolution, as we are
  ...
  camera shake removal with non-stationary blur within the
  computational photography and computer vision community (see
  \cite{hirsch2011}).
