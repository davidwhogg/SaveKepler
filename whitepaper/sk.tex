...
\begin{center}
\footnotesize
\hspace{-1mm}Hi-res PSF \hspace{14mm} Simulated image \hspace{14mm} Model image
...
\caption{Two-star toy example to demonstrate that precise image
  ...
  red frames depicted in the observed image in the top panel show the
  apertures used for pixel averaging.}
\end{center}
...
\caption{Photometric results for the toy example shown above
  ...
  frames in the top panel in the figure above. Note, that in the drift case the footprints of the two
