...
Motivated by the ``371-roll'' scenario%
  \footnote{See the \textit{Explanatory Appendix to the Kepler Project call for white papers:
    Kepler 2-Wheel Pointing Control} (\url{http://keplergo.arc.nasa.gov/docs/Kepler-2-Wheel-pointing-performance.pdf}).}
