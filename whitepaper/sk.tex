...
In the pointing-stability best-case 371-roll scenario,
  the long cadence of 30-min exposures can be continued without change.  \footnote{We note that the 371-roll scenario maintains the s/c in a very stable thermal environment, which may simplify calibration.}
