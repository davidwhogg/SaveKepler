...
Additional data collected with two-wheel \Kepler
  could significantly enhance the number and fidelity of Earth-analog-candidates
...
without exploiting the full flexibility of the model is promising.
...
the basis.
This model removes most of the stellar variability in the light curve without
significantly reducing the transit signal.
Again, we do not have a sound quantitative argument demonstrating the power of
