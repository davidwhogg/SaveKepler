...
In the two-wheel era, it will not be possible
  ...
  as it was in the three- and four-wheel eras\footnote{\url{http://keplerscience.arc.nasa.gov/docs/Kepler-2-Wheel-pointing-performance.pdf}}
(HOGG CITE TECH DOCUMENTS).
...
We examine an aperture around a single target,
