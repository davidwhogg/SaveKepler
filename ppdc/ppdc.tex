...
\title{Improving the accuracy of \Kepler\ photometry: \\
  A data-driven model of the pixels.}
...
\begin{abstract}
There are many tiny features in \Kepler\ light-curves that are
  thought to be caused by small changes in spacecraft pointing, orientation, and temperature.
These features are small, but much larger than the transit signals of greatest interest;
...
Because they are spacecraft-induced, the features can be seen repeated
  across many pixels across the focal plane, albeit with different
  amplitudes and signs.
\end{abstract}
